import { IRequester } from "./crawler";
 ...
 */
export declare function getSubtitles({ videoID, lang, requester }: ISubtitleOptions): Promise<ISubtitle[]>;
/**
 * Retrieves Subtitles for certain youtube video
 *
 * @export
 ...
 */
export declare function getSubtitlesContent({ videoID, lang, requester }: ISubtitleOptions): Promise<string>;
